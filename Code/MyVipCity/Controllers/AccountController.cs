...
namespace MyVipCity.Controllers {
	...
	public class AccountController: Controller {
		...
		public async Task<ActionResult> Login(LoginViewModel model, string returnUrl) {
			// if there are errors, then return an array with all the errors
			...
			switch (result) {
				...
				case SignInStatus.LockedOut: {
						Response.StatusCode = (int)HttpStatusCode.Forbidden;
						return Json("This account has been locked out, please try again later");
					}
		...
		public async Task<ActionResult> Register(RegisterViewModel model) {
			...
			// If we got this far, something failed, get the errors from the model state
			var errors = GetModelStateErrors(ModelState);
			// set response status code to Forbidden
			Response.StatusCode = (int)HttpStatusCode.Forbidden;
			return Json(errors);
		}
